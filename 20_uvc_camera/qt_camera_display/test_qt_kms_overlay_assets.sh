...
require_grep "settingsSegmentMinComponentPixels" "qml/Main.qml"
require_grep "settingsSegmentReviewPixels" "qml/Main.qml"
require_grep "settingsSegmentBadPixels" "qml/Main.qml"
require_grep "settingsSegmentStrongComponentPixels" "qml/Main.qml"
require_grep "settingsUnetPopupVisible" "qml/Main.qml"
require_grep "id: settingsUnetPopup" "qml/Main.qml"
require_grep "id: settingsUnetParameterColumn" "qml/Main.qml"
require_grep "openUnetSettingsPopup" "qml/Main.qml"
require_grep "segment-min-component" "qml/Main.qml"
require_grep "segment-review" "qml/Main.qml"
require_grep "segment-bad" "qml/Main.qml"
require_grep "segment-strong-component" "qml/Main.qml"
require_grep "保存到板端 JSON" "qml/Main.qml"
require_grep "UNet 证据为 CLEAR" "qml/Main.qml"
require_grep "UNet 证据为 WEAK" "qml/Main.qml"
require_grep "UNet 证据为 STRONG" "qml/Main.qml"
...
require_grep "--min-component-pixels" "README.md"
require_grep "--review-defect-pixels" "README.md"
require_grep "--bad-defect-pixels" "README.md"
require_grep "--strong-component-pixels" "README.md"
...
require_grep "segmentMinComponentPixels" "main.cpp"
require_grep "segmentReviewPixels" "main.cpp"
require_grep "segmentBadPixels" "main.cpp"
require_grep "segmentStrongComponentPixels" "main.cpp"
require_grep "segment_min_component_pixels" "main.cpp"
require_grep "segment_review_pixels" "main.cpp"
require_grep "segment_bad_pixels" "main.cpp"
require_grep "segment_strong_component_pixels" "main.cpp"
...
require_grep "--min-component-pixels" "main.cpp"
require_grep "--review-defect-pixels" "main.cpp"
require_grep "--bad-defect-pixels" "main.cpp"
require_grep "--strong-component-pixels" "main.cpp"
if grep -Fq 'QStringLiteral("--min-defect-pixels")' "$SCRIPT_DIR/main.cpp"; then
    fail "main.cpp 不能继续向 defect-segment 传旧 --min-defect-pixels，必须传四个证据阈值"
fi
...
require_grep "--min-component-pixels" "defect_segment.cpp"
require_grep "--review-defect-pixels" "defect_segment.cpp"
require_grep "--bad-defect-pixels" "defect_segment.cpp"
require_grep "--strong-component-pixels" "defect_segment.cpp"
require_grep "defect_segment_evidence.h" "defect_segment.cpp"
require_grep "analyze_segment_evidence" "defect_segment_evidence.h"
require_grep "SegmentEvidenceLevel::Clear" "test_defect_segment_evidence.cpp"
require_grep "SegmentEvidenceLevel::Weak" "test_defect_segment_evidence.cpp"
require_grep "SegmentEvidenceLevel::Strong" "test_defect_segment_evidence.cpp"
...
require_grep "evidence=" "defect_segment.cpp"
...
require_grep "kDefaultStrongComponentPixels" "defect_segment_evidence.h"
require_grep "segment_evidence_level_from_stats" "defect_segment_evidence.h"
...
require_grep "segment_evidence" "main.cpp"
require_grep "filtered_defect_pixels" "main.cpp"
require_grep "largest_component_pixels" "main.cpp"
require_grep "UNet 回显阈值与本轮板端参数不一致" "main.cpp"
require_grep "UNet 证据等级与连通域统计不一致" "main.cpp"
require_grep "segment_evidence_level_from_stats" "main.cpp"
require_grep "存在可疑缺陷" "main.cpp"
require_grep "小噪点已过滤" "main.cpp"
require_fixed_grep 'result.historyText = QStringLiteral("坏品")' "main.cpp"
